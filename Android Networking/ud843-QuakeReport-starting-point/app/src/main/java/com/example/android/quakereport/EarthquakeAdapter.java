...
public class EarthquakeAdapter extends ArrayAdapter<Earthquake> {
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        //find earthquake at the given position
        ...
        //find Textview with view ID locationoffset
        TextView offsetlocationView = (TextView) listitemview.findViewById(R.id.locationOffset);
        //Display the offset location of the current earthquake in the TextView
        offsetlocationView.setText(locationOffset);

        //find Textview with view ID primarylocatiom
        TextView primaryLocationView = (TextView) listitemview.findViewById(R.id.primaryLocation);
        //Display the primary location of the current earthquake in the TextView
    ...
    /**
     * @param magnitude
     * @return the color of the magnitude background
     */
